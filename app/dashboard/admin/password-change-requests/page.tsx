...
export default function PasswordChangeRequestsPage() {
  ...
  const handleApprove = async (request: PasswordChangeRequest) => {
    ...
    try {
      ...
      alert(`Demande approuvée. Le nouveau mot de passe est: ${newPassword}\n\nIMPORTANT: Vous devez maintenant changer le mot de passe dans Supabase Dashboard pour l'utilisateur: m${request.member.member_id.replace(/-/g, '')}@example.com`);
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p className="text-sm text-blue-800">
                      <strong>Note:</strong> Après approbation, vous devrez changer le mot de passe dans Supabase Dashboard pour l&apos;utilisateur: <code className="bg-blue-100 px-1 rounded">m{selectedRequest.member?.member_id.replace(/-/g, '')}@example.com</code>
                    </p>
                  </div>
